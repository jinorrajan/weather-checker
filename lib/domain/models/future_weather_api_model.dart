...
FutureWeatherApiModel weatherApiModelFromJson(String str) => FutureWeatherApiModel.fromJson(json.decode(str));

String weatherApiModelToJson(FutureWeatherApiModel data) => json.encode(data.toJson());
...
class FutureWeatherApiModel {
    ...
    factory FutureWeatherApiModel.fromJson(Map<String, dynamic> json) => FutureWeatherApiModel(
        cod: json["cod"],
